...
const FinalReleaseButton = ({
  ...
  const releaseDocument = () => {
    openModal
      ? toggleModal()
      : Swal.fire({
          title: "Click Yes to Releaasasasasse",
          icon: "warning",
  ...
  const validation = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      business_permit: Yup.string().required("Please Enter Business Code"),
                ...
                <Col md="6">
                  <div className="mb-3">
                    ...
                    <Input
                      ...
                      type="text"
                      placeholder="Enter Business Permit"
...
export default FinalReleaseButton;
