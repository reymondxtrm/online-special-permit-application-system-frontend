...
import { Form, Col, Button, InputGroup, Label } from "reactstrap";
...
const Filter = ({ action, updateFilter }) => {
  ...
  const validation = useFormik({
    ...
    initialValues: {
      date_from: date_from || "",
      date_to: date_to || "",
      type: permitTypeOptions?.[0] || { value: "", label: "" },
    },
  ...
  return (
    ...
    >
      <div className="d-flex gap-2">
        ...
        <InputGroup className="d-flex flex-column" style={{ width: "180px" }}>
